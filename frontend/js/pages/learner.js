...
import { $, $all, el, icons, toast, gapClass, gapColor, animateCount, destroyChart, formatDate, friendlyError, greetingWithName } from '../utils.js';
...
export async function renderDashboard() {
  ...
  <div class="page-head"><div><h1>${greetingWithName(firstName)}.</h1><p>Here is your current competency intelligence. Role: <b>${state.role.name.toUpperCase()}</b></p></div>
