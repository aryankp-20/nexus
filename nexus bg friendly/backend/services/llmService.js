...
Rules: exactly 4 options, exactly one correct option, the question and explanation must be answerable using only the given context, difficulty should be ${difficulty}.`;
